...
<h4>Latest Products </h4>
     ...
     <a  href="{{route('productView',$new_product->id)}}"><img src="{{asset('uploads/'.$new_product->image)}}" alt=""/></a>
        ...
        <h4 style="text-align:center"><a class="btn" href="{{route('productView',$new_product->id)}}"> <i class="icon-zoom-in"></i></a> <a class="btn" href="#">Add to <i class="icon-shopping-cart"></i></a> <a class="btn btn-primary" href="#">${{$new_product->price}}</a></h4>
            </div>
          </div>
        </li>
        @endforeach
